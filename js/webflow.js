 ...
 */ !(function (t) {
            ...
            if (t) {
              ...
              if ("object" == o) {
                ...
                p.call(
                  ...
                  d.call(this),
                  s > 0 &&
                    ((this.timer = new W({ duration: s, context: this })), (this.active = !0), e && (this.timer.complete = a));
                var v = this,
                  h = !1,
                  g = {};
                P(function () {
            ...
            for (o in t)
              (u = t[o]),
                o in q
                  ...
                  : (E.test(o) && (o = n(o)), o in Q ? (f[o] = u) : (c || (c = {}), (c[o] = u)));
            for (o in f) {
          ...
          (t.init = function () {
            e.init.apply(this, arguments),
              this.current ||
                ...
                q.perspective &&
                  H.perspective &&
                  ((this.current.perspective = H.perspective), z(this.el, this.name, this.style(this.current)), this.redraw()));
          }),
            (t.set = function (t) {
          ...
          (e.init = function (t) {
            ...
            (e.stop = function () {
              ...
              this.active &&
                ((this.active = !1),
                (e = this),
                (r = t.inArray(e, c)) >= 0 && ((n = c.slice(r + 1)), (c.length = r), n.length && (c = c.concat(n))));
            }),
            (e.render = function (t) {
              var e,
                n = t - this.start;
  ...
  function (t, e, n) {
    ...
    function at(t) {
      ...
      i && n.dispatch((0, m.rawDataImported)(i)),
        u.active ||
          (n.dispatch((0, m.sessionInitialized)({ hasBoundaryNodes: Boolean(document.querySelector(A)) })),
          o &&
            ((function (t) {
                    ...
                    ? (function (t) {
                        ...
                        !(function (t) {
                          if (J) {
                            ...
                            for (var r in t) {
                              ...
                              e[u] ||
                                (o !== E.EventTypeConsts.MOUSE_CLICK && o !== E.EventTypeConsts.MOUSE_SECOND_CLICK) ||
                                ((e[u] = !0), (n += u + "{cursor: pointer;touch-action: manipulation;}"));
                            }
                            if (n) {
                        ...
                        if ((0, f.default)(d)) {
                          (0, v.default)(d, function (t, e) {
                            ...
                            if (
                              (Y(p, u.mediaQueryKeys) || n.dispatch((0, m.mediaQueriesDefined)()),
                                        ...
                                        n.forEach(function (t) {
                                          ...
                                          if (o) {
                                            ...
                                            if (
                                              ...
                                              E[u] = !0;
                                              var c = t.config;
                                              C({ config: c, event: h, eventTarget: i, elementRoot: a, elementApi: y }).forEach(
                                                function (t) {
                            ...
                            (a.actionTypeId === E.ActionTypeConsts.GENERAL_START_ACTION || T(a.actionTypeId)) &&
                                ...
                                if (B(p, r.mediaQueryKey)) {
                                  var v = function () {
                                    var r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                      i = a(
                                        { store: n, element: e, event: s, eventConfig: r, nativeEvent: t, eventStateKey: c },
                                        f
                                      );
            ...
            n.getState().ixSession.hasDefinedMediaQueries &&
              (function (t) {
                P({
                  ...
                  onChange: function () {
                    ut(t), F({ store: t, elementApi: y }), at({ store: t, allowEvents: !0 }), nt();
                  }
                });
              })(n)),
      ...
      pt = function (t) {
        ...
        return n && n.length
          ? n.reduce(function (t, e) {
              var n = { target: e };
              return t.concat(C({ config: n, elementApi: y }));
            }, [])
          : C({ config: { target: e }, elementApi: y });
      };
    function vt(t) {
      var e = t.store,
        n = t.actionListId,
      ...
      if (f && f.useFirstGroupAsInitialState) {
        ...
        l.forEach(function (t) {
          var i = t.config,
            o = t.actionTypeId,
            a = C({ config: i, event: c, elementApi: y }),
            u = Q(o);
          a.forEach(function (i) {
            var a = u ? q(o)(i, t) : null;
            _t({
              destination: D({ element: i, actionItem: t, elementApi: y }, a),
              immediate: !0,
              store: e,
              element: i,
              eventId: r,
    ...
    function ht(t) {
      ...
      (0, v.default)(n, function (t) {
        if (!t.continuous) {
          var n = t.actionListId,
            r = t.verbose;
          mt(t, e), r && e.dispatch((0, m.actionListPlaybackChanged)({ actionListId: n, isPlaying: !1 }));
        }
      });
    }
    function gt(t) {
      ...
      (0, v.default)(u, function (t) {
        ...
        if (t.actionListId === o && t.eventId === n && a) {
          ...
          mt(t, e), t.verbose && e.dispatch((0, m.actionListPlaybackChanged)({ actionListId: o, isPlaying: !1 }));
        }
      });
    }
    function Et(t) {
      ...
      var b =
          (0 === c || (1 === c && I)) && T(null === (e = h.action) || void 0 === e ? void 0 : e.actionTypeId)
            ? h.config.delay
            : void 0,
    ...
    function _t(t) {
      var e = t.store,
        ...
        E = y.getRefType(o),
        _ = G(o, g, n, c, y, f);
      e.dispatch((0, m.instanceAdded)((0, a.default)({ instanceId: l, elementId: h, origin: _, refType: E }, r))),
  ...
  function (t, e, n) {
    n(121), n(123), n(37), n(125), n(313), n(314), n(315), n(316), n(321), n(322), (t.exports = n(323));
  },
  function (t, e, n) {
    "use strict";
    var r = n(4);
                ...
                (function (t) {
                  ...
                  var n = function n(r) {
                    "WF_third_party_cookies_unsupported" === r.data
                      ? (E(e, n), t(!1))
                      : "WF_third_party_cookies_supported" === r.data && (E(e, n), t(!0));
                  };
                  (e.onerror = function () {
                    E(e, n), t(!1);
                  }),
    ...
    i("inspectSource", function (t) {
      ...
      (t.exports = function (t, e, n, i) {
        var c = !!i && !!i.unsafe,
          ...
          f = !!i && !!i.noTargetGet;
        "function" == typeof n &&
          ("string" != typeof e || a(n, "name") || o(n, "name", e), (l(n).source = d.join("string" == typeof e ? e : ""))),
  ...
  function (t, e, n) {
    ...
    e.ixSession = function () {
      ...
      switch (e.type) {
        ...
        case v:
          for (var O = e.payload, A = O.width, x = O.mediaQueries, S = x.length, R = null, N = 0; N < S; N++) {
            var C = x[N],
              L = C.key,
              D = C.min,
              P = C.max;
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, g, E, _) {
      ...
      if (O && !T) return _ || (_ = new r()), m || f(t) ? i(t, e, n, g, E, _) : o(t, e, I, n, g, E, _);
      if (!(n & l)) {
  ...
  function (t, e, n) {
    ...
    (a["[object Float32Array]"] = a["[object Float64Array]"] = a["[object Int8Array]"] = a["[object Int16Array]"] = a[
      ...
      (a["[object Arguments]"] = a["[object Array]"] = a["[object ArrayBuffer]"] = a["[object Boolean]"] = a[
        "[object DataView]"
      ] = a["[object Date]"] = a["[object Error]"] = a["[object Function]"] = a["[object Map]"] = a["[object Number]"] = a[
        "[object Object]"
      ] = a["[object RegExp]"] = a["[object Set]"] = a["[object String]"] = a["[object WeakMap]"] = !1),
      (t.exports = function (t) {
  ...
  function (t, e, n) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
        ...
        switch (i) {
          ...
          case ot:
            var s = r.getStyle,
              ...
              g = h.widthValue,
              E = h.heightValue;
            if (!m.IS_BROWSER_ENV) return { widthValue: g, heightValue: E };
            if (p === B) {
              var y = s(e, D);
          ...
          case K:
            return (function (t, e, n, r, i) {
              ...
              Nt(t, m.TRANSFORM_PREFIXED, i),
                ...
                (l = c.yValue),
                (d = c.zValue),
                ((s === J && void 0 !== d) || (s === tt && void 0 !== d) || (s === et && (void 0 !== f || void 0 !== l))) &&
                  a(t, m.TRANSFORM_STYLE_PREFIXED, R);
              var u, c, s, f, l, d;
            })(t, e, n, i, a);
          case q:
              ...
              switch (u) {
                case ot:
                  ...
                  void 0 !== h && (d === B && (d = "px"), Nt(t, D, o), a(t, D, h + d)),
                    void 0 !== g && (v === B && (v = "px"), Nt(t, P, o), a(t, P, g + v));
                  break;
                case it:
                  !(function (t, e, n, r) {
                    var i = (0, l.default)(
      ...
      (e.shouldNamespaceEventParameter = function (t, e) {
        var n = e.basedOn;
        return (
          (t === g.EventTypeConsts.SCROLLING_IN_VIEW && (n === g.EventBasedOn.ELEMENT || null == n)) ||
          (t === g.EventTypeConsts.MOUSE_MOVE && n === g.EventBasedOn.ELEMENT)
        );
      }),
    ...
    function mt(t) {
      ...
      var A,
        ...
        C = n && u(_t(n.target));
      if (
        (N ? ((A = R.limitAffectedElements), (x = C), (S = u(R))) : (x = S = u({ id: _, selector: I, selectorGuids: b })), n && w)
      ) {
        var L = r && (S || !0 === w) ? [r] : c(C);
        if (S) {
          if (w === U)
            return c(S).filter(function (t) {
    ...
    function Dt(t) {
      ...
      e.actionItems.forEach(function (t) {
        var e,
          i = t.actionTypeId,
          o = t.config;
        (e = (0, _.isPluginType)(i) ? (0, _.clearPlugin)(i) : Pt({ effect: Mt, actionTypeId: i, elementApi: r })),
      ...
      b = function (t, e) {
        ...
        for (var O = 0, A = i.length; O < A; O++) {
          ...
          if ((0 === O && (g = R[0]), w >= S)) {
            ...
            var N = i[O + 1],
              C = N && w !== S;
            (E = C ? N.actionItems[0] : null), C && ((_ = S / 100), (y = (N.keyframe - S) / 100));
          }
        }
        var L = {};
        if (g && !E)
          ...
          for (var j = (T - _) / y, F = g.config.easing, k = h(F, j, f), X = 0, G = a.length; X < G; X++) {
            var U = a[X],
              V = m(s, U, g.config),
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n) {
      ...
      return (
        (e = o(e) || 0),
        r(n) &&
          ((g = !!n.leading), (l = (E = "maxWait" in n) ? u(o(n.maxWait) || 0, e) : l), (_ = "trailing" in n ? !!n.trailing : _)),
        (T.cancel = function () {
  ...
  function (t, e, n) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      ...
      (e.getSiblingElements = function () {
        for (
          var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], e = [], n = [], r = 0, i = t.length;
          r < i;
          r++
        ) {
          ...
          handler: function (t) {
            ...
            return (
              ...
              (u !== h.EventBasedOn.ELEMENT || x || x !== a.elementHovered) &&
                ((O = f ? 1 - O : O), e.dispatch((0, E.parameterChanged)(A, O))),
              ...
              x(
                (e.html &&
                  ...
                  "data:image/svg+xml;charset=utf-8," +
                    encodeURI('<svg xmlns="http://www.w3.org/2000/svg" width="' + d + '" height="' + p + '"/>'))) ||
                  e.url,
                function (r) {
                  if (t === o) {
                    var i,
                      ...
                      p = P("frame").append(d),
                      g = P("view").append(p);
                    e.html && ((a = (i = n(e.html)).is("iframe")) && i.on("load", E), d.append(C(i, "embed"))),
          ...
          if (i) {
            ...
            !(function (t) {
              ...
              (e = i.group)
                ? ((r = n[e]) || (r = n[e] = []),
                  (t.items = r),
                  i.items.length && ((t.index = r.length), r.push.apply(r, i.items)))
    ...
    r.define(
      ...
      (t.exports = function (t, e) {
                    ...
                    return function (e) {
                      if (t.open)
                        switch (((t.selectedIdx = t.links.index(document.activeElement)), e.keyCode)) {
                          ...
                          case o.ARROW_UP:
                            return (
                              (t.selectedIdx = Math.max(-1, t.selectedIdx - 1)), N(t), e.preventDefault(), e.stopPropagation()
                            );
                          case o.ARROW_RIGHT:
                          case o.ARROW_DOWN:
                            return (
        ...
        function G(t) {
          ...
          return (
            e.animOver ? t.menu.height(r) : "fixed" !== t.el.css("position") && (r -= t.el.outerHeight(!0)),
          ...
          function c() {
            t.menu.height(""),
              ...
              t.overlay &&
                ...
                (T.length ? t.menu.insertAfter(T) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()),
    ...
    r.define(
      ...
      (t.exports = function (t, e) {
        var n,
          ...
          E = i.triggers;
        function _() {
          (n = d.find(v)).length && (n.each(I), (s = null), c || (m(), r.resize.on(y), r.redraw.on(f.redraw)));
        }
        function m() {
        ...
        function L(e, n) {
          ...
          o < 0
            ...
            : o >= i.length &&
              ((o = 0), r.infinite && ((c.x = i[i.length - 1].width), (c.from = -i[i.length - 1].x), (c.to = c.from - c.x))),
            (e.index = o);
          ...
          e.nav.children().not(f).removeClass("w-active").attr("aria-selected", "false").attr("tabindex", "-1"),
            r.hideArrows &&
              (e.index === i.length - 1 ? e.right.hide() : e.right.show(), 0 === e.index ? e.left.hide() : e.left.show());
          var d = e.offsetX || 0,
          ...
          if (e.index !== e.previous) {
            if ((e.ariaLiveLabel.text("Slide ".concat(o + 1, " of ").concat(i.length, ".")), "cross" === m)) {
            ...
            r.infinite && c.x
              ? (l(e.slides.not(g)).set({ visibility: "", x: c.x }).add(w).start({ x: p }),
                l(g).set({ visibility: "", x: c.from }).add(w).start({ x: c.to }),
                (e.shifted = g))
              : (r.infinite && e.shifted && (l(e.shifted).set({ visibility: "", x: d }), (e.shifted = null)),
                l(e.slides).set({ visibility: "" }).add(w).start({ x: p }));
          }
          function x() {
            (h = t(i[e.index].els)), (_ = e.slides.not(h)), "slide" !== m && (v.visibility = "hidden"), l(_).set(v);
          }
        }
        function D(e, n) {
          var r = t.data(n, v);
        ...
        function P(e) {
          ...
          c < 0 && (c = 0),
            ...
            e.slides.each(function (u, s) {
              i - r > c && (n++, (r += a), (e.anchors[n - 1] = { els: [], x: i, width: 0 })),
                (o = t(s).outerWidth(!0)),
                (i += o),
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        selector: ".filled-btn",
        originalId: "5d41974e8cacf51263debe88|1fc0c150-1781-fb19-1e70-c27c666aa0dd",
        appliesTo: "CLASS"
      },
      targets: [
        {
    ...
    "e-3": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5d41974e8cacf51263debe88|fd366e5c-22fa-bc54-348e-034cc007529c" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "5d41974e8cacf51263debe88|fd366e5c-22fa-bc54-348e-034cc007529c" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-5": {
      ...
      target: {
        ...
        originalId: "5d41974e8cacf51263debe88|1b7165c1-fc3c-4616-70fb-b4742b4b4b05",
        appliesTo: "CLASS"
      },
      targets: [
        {
    ...
    "e-7": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "e4782b48-1640-8777-bfa9-4868f8f6502d" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "e4782b48-1640-8777-bfa9-4868f8f6502d" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-9": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { selector: ".project-img", originalId: "f83d63b5-8f5b-cba3-090e-b0f75e1c002a", appliesTo: "CLASS" },
      targets: [{ selector: ".project-img", originalId: "f83d63b5-8f5b-cba3-090e-b0f75e1c002a", appliesTo: "CLASS" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-14": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "PAGE", styleBlockIds: [], id: "ivangonzalez" },
      targets: [{ appliesTo: "PAGE", styleBlockIds: [], id: "ivangonzalez" }],
      config: {
        loop: true,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-17": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "ivangonzalez|f40f5af0-7b8e-a56a-c719-6da4f41382c3" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "ivangonzalez|f40f5af0-7b8e-a56a-c719-6da4f41382c3" }],
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-19": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "943b9552-ffcf-e5d6-7d6f-a92fa989b31c" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "943b9552-ffcf-e5d6-7d6f-a92fa989b31c" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: 40,
    ...
    "e-21": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "ivangonzalez|511d32f0-f78c-7b5b-3a3e-b948193a063f" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "ivangonzalez|511d32f0-f78c-7b5b-3a3e-b948193a063f" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: 40,
    ...
    "e-28": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "ivangonzalez|b1497dac-4fd9-a0d1-a8f8-870844029ebb" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "ivangonzalez|b1497dac-4fd9-a0d1-a8f8-870844029ebb" }],
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-33": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "d1ee1510-e7d7-10c2-38fa-cd113c6b70a5" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "d1ee1510-e7d7-10c2-38fa-cd113c6b70a5" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-35": {
      ...
      target: {
        ...
        originalId: "5d42bc857ac7880203816f9b|6e2c00c3-6eec-27ad-d375-fb4900644d26",
        appliesTo: "CLASS"
      },
      targets: [
        {
    ...
    "e-37": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5d42bc857ac7880203816f9b|9d722b2f-fcd5-7999-ed42-d7e5811eefdc" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "5d42bc857ac7880203816f9b|9d722b2f-fcd5-7999-ed42-d7e5811eefdc" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-41": {
      ...
      mediaQueries: ["main"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5d42bc857ac7880203816f9b|1a03e3cf-a331-b3ab-f50f-f3b3125dbc6c" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "5d42bc857ac7880203816f9b|1a03e3cf-a331-b3ab-f50f-f3b3125dbc6c" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-46": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "PAGE", styleBlockIds: [], id: "5d42cd4641794c6697512cb2" },
      targets: [{ appliesTo: "PAGE", styleBlockIds: [], id: "5d42cd4641794c6697512cb2" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-47": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "d1ee1510-e7d7-10c2-38fa-cd113c6b70a6" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "d1ee1510-e7d7-10c2-38fa-cd113c6b70a6" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-57": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5d42bc857ac7880203816f9b|1abc661a-f7ac-5987-0902-b31675266b73" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "5d42bc857ac7880203816f9b|1abc661a-f7ac-5987-0902-b31675266b73" }],
      config: [
        {
    ...
    "e-58": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5d42bc857ac7880203816f9b|26e5d7b0-0ed0-3c36-cfec-94b954ce3841" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "5d42bc857ac7880203816f9b|26e5d7b0-0ed0-3c36-cfec-94b954ce3841" }],
      config: [
        {
          continuousParameterGroupId: "a-13-p",
          smoothing: 80,
    ...
    "e-59": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5d42bc857ac7880203816f9b|43a0c002-9c9d-c7b7-2133-4a0725ee1952" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "5d42bc857ac7880203816f9b|43a0c002-9c9d-c7b7-2133-4a0725ee1952" }],
      config: [
        {
          continuousParameterGroupId: "a-17-p",
          smoothing: 80,
    ...
    "e-60": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "e4782b48-1640-8777-bfa9-4868f8f6502e" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "e4782b48-1640-8777-bfa9-4868f8f6502e" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-86": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5d42bc857ac7880203816f9b|292a97e6-d46a-86b0-e1e2-232113906eb9" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "5d42bc857ac7880203816f9b|292a97e6-d46a-86b0-e1e2-232113906eb9" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-92": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5d51a7034c908f37098b89f3|7b78a85a-9ea5-da23-03ee-1ea6bbc5040d" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "5d51a7034c908f37098b89f3|7b78a85a-9ea5-da23-03ee-1ea6bbc5040d" }],
      config: [
        {
    ...
    "e-95": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5d51a7034c908f37098b89f3|7b78a85a-9ea5-da23-03ee-1ea6bbc50420" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "5d51a7034c908f37098b89f3|7b78a85a-9ea5-da23-03ee-1ea6bbc50420" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-117": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5d51a7034c908f37098b89f3|54e231b7-ab81-6bf8-7a8a-95d79433bb64" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "5d51a7034c908f37098b89f3|54e231b7-ab81-6bf8-7a8a-95d79433bb64" }],
      config: [
        {
    ...
    "e-119": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "PAGE", styleBlockIds: [], id: "5d42bc857ac7880203816f9b" },
      targets: [{ appliesTo: "PAGE", styleBlockIds: [], id: "5d42bc857ac7880203816f9b" }],
      config: {
        loop: true,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-122": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "ivangonzalez|615aa8c2-f20f-aa5f-a14e-ee76fde7878b" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "ivangonzalez|615aa8c2-f20f-aa5f-a14e-ee76fde7878b" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    "e-124": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "ivangonzalez|ebd761a4-128b-0c6b-e299-c022da03614a" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "ivangonzalez|ebd761a4-128b-0c6b-e299-c022da03614a" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: 40,
    ...
    "e-129": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5d51a7034c908f37098b89f3|e0f85e50-8dbf-a7d2-5a0a-1374dc8921be" },
      targets: [{ appliesTo: "ELEMENT", styleBlockIds: [], id: "5d51a7034c908f37098b89f3|e0f85e50-8dbf-a7d2-5a0a-1374dc8921be" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: 40,
    ...
    "e-132": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: { selector: ".nav-link-inline", originalId: "5e49b6bc-459f-fa33-9866-147f8b57b65f", appliesTo: "CLASS" },
      targets: [{ selector: ".nav-link-inline", originalId: "5e49b6bc-459f-fa33-9866-147f8b57b65f", appliesTo: "CLASS" }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: "ease",
                duration: 200,
                target: { selector: ".line-1", selectorGuids: ["98f4d971-0f5e-2e71-2e0d-d0bf9bf08f72"] },
                zValue: 45,
                xUnit: "DEG",
                yUnit: "DEG",
                zUnit: "DEG"
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: "outQuart",
                duration: 600,
                target: { selector: ".arrow-wrapper", selectorGuids: ["c6b2632b-45d8-45ca-bd88-2977ea86467a"] },
                yValue: -24,
                xUnit: "PX",
                yUnit: "PX",
                zUnit: "PX"
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { selector: ".hero-col-left", selectorGuids: ["a2548f52-a085-a39f-39a4-50f265e101ff"] },
                xValue: -80,
                xUnit: "PX",
                yUnit: "PX",
                zUnit: "PX"
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { selector: ".blue-shape-hero", selectorGuids: ["ab5ca731-d168-38be-b105-91584eea6ea8"] },
                xValue: 0,
                yValue: 1,
                locked: false
              }
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { selector: ".hero-img-backdrop", selectorGuids: ["8772a963-0eb9-0010-49fc-ac910dbbe055"] },
                xValue: 80,
                yValue: -80,
                xUnit: "PX",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { selector: ".hero-img", selectorGuids: ["280870d1-99ad-cfca-6551-973b1a67a07a"] },
                value: 0,
                unit: ""
              }
            },
            ...
            },
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { selector: ".hero-img-overlay", selectorGuids: ["0496f736-9a37-edb3-c8f5-a78ad1fdf9c7"] },
                xValue: 0,
                yValue: 1,
                locked: false
              }
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: "",
                duration: 0,
                target: { selector: ".page-wrapper", selectorGuids: ["a2dd074d-6a41-4e8d-6188-1b2309b9b069"] },
                value: 1,
                unit: ""
              }
            },
            {
              ...
              config: {
                ...
                easing: "ease",
                duration: 400,
                target: { selector: ".loading-page", selectorGuids: ["1add21d8-644c-90af-77ab-7994079f0872"] },
                value: 0,
                unit: ""
              }
            }
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                duration: 0,
                value: "block",
                target: { selector: ".hero-img-overlay-wrapper", selectorGuids: ["4d76c2a1-7ace-7d67-7d3b-8d178f31f786"] }
              }
            },
            {
              id: "a-12-n-18",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: "ease",
                duration: 800,
                target: { selector: ".loading-circle", selectorGuids: ["c92a4d91-c7e2-d8d0-7c47-1a4805e8c143"] },
                zValue: 360,
                xUnit: "DEG",
                yUnit: "DEG",
                zUnit: "DEG"
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: "",
                duration: 500,
                target: { selector: ".grid-btn-tooltip", selectorGuids: ["d76f6a4f-9d4a-6288-bd34-5183b98e238f"] },
                yValue: 24,
                xUnit: "PX",
                yUnit: "PX",
                zUnit: "PX"
