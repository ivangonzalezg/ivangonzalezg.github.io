...
export const content: Record<"en" | "es", Translation> = {
  en: {
    meta: {
      ...
      description:
        "Scalable Software Architecture & Native Solutions. Specialized in React Native, Applied AI, and High-Performance Backends.",
    },
    nav: {
      work: "Work",
      about: "Stack",
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "A 'Second Brain' for personal wellness. Unlike static trackers, Gloflow uses AI Agents and Vector Memory to learn from your daily habits, injuries, and routines. It provides hyper-personalized recovery plans and health insights that adapt over time, preventing burnout before it happens.",
        ...
        },
        {
          ...
          description:
            "Enterprise quoting engine for ADO (Mexico's largest bus fleet). It digitalizes the charter process, reducing quote generation time from days to seconds. The system dynamically optimizes operational costs—tolls, fuel, driver shifts—using real-time geospatial algorithms.",
    ...
    techStack: {
      ...
      description:
        "I don't just use frameworks; I understand their internals. My stack is chosen for stability, performance, and long-term maintainability.",
      categories: techStackData,
    },
    footer: {
      title: "Ready to scale your product?",
      subtitle:
        "I am currently open to select freelance projects and technical consulting. If you need robust engineering, let's talk.",
  ...
  es: {
    meta: {
      ...
      description:
        "Arquitectura de Software Escalable y Soluciones Nativas. Especializado en React Native, IA Aplicada y Backends de Alto Rendimiento.",
    },
    nav: {
      work: "Proyectos",
      about: "Stack",
    ...
    valueProps: [
      {
        ...
        description:
          "Código diseñado para crecer. Arquitecturas construidas para soportar alta concurrencia y futuras expansiones sin refactorización.",
        icon: "layers",
      },
      {
        title: "Maestría Híbrida + Nativa",
        description:
          "Lo mejor de ambos mundos. Desarrollo ágil con Expo/React Native, potenciado por Módulos Nativos personalizados (Java/Kotlin/Swift) cuando el rendimiento lo exige.",
        icon: "smartphone",
      },
      {
        title: "Integración de Datos e IA",
        description:
          "Ecosistemas backend avanzados. Integraciones fluidas con Supabase, Strapi y Firebase, implementando Memoria Vectorial y Agentes de IA.",
        icon: "cpu",
      },
    ],
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          tags: ["Expo", "AI Agents", "Supabase", "Vector Embeddings"],
          description:
            "Un 'Segundo Cerebro' para tu bienestar. A diferencia de trackers estáticos, Gloflow utiliza Agentes de IA y Memoria Vectorial para aprender de tus hábitos, lesiones y rutinas diarias. Ofrece planes de recuperación y prevención hiper-personalizados que evitan el desgaste físico antes de que ocurra.",
          logoUrl:
        ...
        },
        {
          ...
          description:
            "Motor de cotización empresarial para ADO (la mayor flota de autobuses de México). Digitaliza el proceso de renta de unidades, reduciendo tiempos de respuesta de días a segundos. El sistema optimiza costos operativos (peajes, combustible, viáticos) en tiempo real mediante algoritmos geoespaciales.",
    ...
    techStack: {
      ...
      description:
        "No solo uso frameworks; entiendo sus componentes internos. Mi stack es elegido por su estabilidad, rendimiento y mantenibilidad a largo plazo.",
      categories: techStackData,
    },
    footer: {
      title: "¿Listo para escalar tu producto?",
      subtitle:
        "Actualmente estoy abierto a proyectos freelance selectos y consultoría técnica. Si necesitas ingeniería robusta, hablemos.",
